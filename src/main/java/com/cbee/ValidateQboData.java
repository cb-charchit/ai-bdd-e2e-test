...
public class ValidateQboData {
    ...
    public static void checkIfRecordIsPresentInQBO(String integ_name, String entity_type, String id) {
        ...
        Token t = authService.getToken(integ_name);
        ...
        ExtractableResponse<Response> response = qbClient.doHttpGet(basePath, params, t.getAccessToken());

        if (response.statusCode() == 401) {
            authService.refreshTheToken();
            ExtractableResponse<Response> response1 = qbClient.doHttpGet(basePath, params, t.getAccessToken());
